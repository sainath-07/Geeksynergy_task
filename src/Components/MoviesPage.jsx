            ...
            <React.Fragment key={i}>
              ...
              >
                ...
                <div className="flex justify-center items-center">
                  <img src={poster} alt="" className="w-full h-[300px] object-cover" />
                </div>
                {/* movie data */}
                <div className="space-y-6">
                  <p className="text-2xl font-bold">{title}</p>
                  <p className="text-xl font-semibold">Genre: {genre}</p>
                  <p className="text-xl font-semibold">Director: {director}</p>
                  <div>
                    {stars.map((star, index) => (
                      <p className="font-semibold flex flex-wrap" key={index}>
                        Stars: {star}
                      </p>
                    ))}
                  </div>
